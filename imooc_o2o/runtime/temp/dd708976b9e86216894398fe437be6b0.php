<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:98:"/Users/iswangweiyan/Desktop/o2o_tp5/imooc_o2o/public/../application/admin/view/category/index.html";i:1570369769;s:97:"/Users/iswangweiyan/Desktop/o2o_tp5/imooc_o2o/public/../application/admin/view/public/header.html";i:1568969831;s:97:"/Users/iswangweiyan/Desktop/o2o_tp5/imooc_o2o/public/../application/admin/view/public/footer.html";i:1570369434;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<body>
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius"
					onclick="o2o_s_edit('添加生活服务分类','<?php echo url('category/add'); ?>','','300')" href="javascript:;"><i
						class="Hui-iconfont">&#xe600;</i> 添加分类</a></span> <span class="r"></span> </div>
		<div class="mt-20">
				...
				<tbody>
					...
					<tr class="text-c">
						...
						<td class="td-manage"><a href="">获取子栏目</a><a style="text-decoration:none" class="ml-5"
								onClick="o2o_s_edit('编辑','','',300)" href="javascript:;" title="编辑"><i
									class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5"
								onClick="o2o_del('','')" href="javascript:;" title="删除"><i
